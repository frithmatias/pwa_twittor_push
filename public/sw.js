...
self.addEventListener('push', e => {
    ...
    const options = {
        ...
        // image: 'http://....jpg', // esta imagen se va a ver en la notificacion debajo del texto, en android se va a ver 
        // como una imagen grande dentro de la notificación que ocupa todo el ancho de la pantalla.
        ...
        openUrl: '/',
        data: {
            url: 'https://frithmatias.github.io/pwa_twittor/',
            id: data.user
        },
        actions: [ // solo permite dos acciones válidas
            {
                action: 'thor-action',
                title: 'Thor',
...
// Eventos que se disparan al hacer click en una notificacion 
